...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-project-gd")
    bq_project = Variable.get("bq_project", default_var="project-12cc638f-14c8-433d-84f")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "296334702522-compute@developer.gserviceaccount.com",
